...
export const translations = {
  ar: {
    ...
    subscriptionWizard: {
      ...
      errors: {
        ...
        alreadySubscribed: "لديكِ اشتراك نشط بالفعل. لا يمكن إنشاء اشتراك جديد.",
      },
    },
    subscriptionDashboard: {
      ...
      planCard: {
        ...
        renewsOn: "تجديد في",
        expiresOn: "ينتهي في",
        monthlySessions: "جلسات الشهر",
        sessionsLeft: "جلسات متبقية",
      },
      stats: {
        included: "الجلسات المشمولة",
        used: "الجلسات المستخدمة",
        remaining: "المتبقي",
        usage: "نسبة الاستخدام",
      },
      plans: {
        sectionTitle: "باقات الرعاية المتاحة",
        sectionSubtitle: "يمكنكِ الترقية أو تغيير اشتراكك في أي وقت.",
        ctaCurrent: "باقتك الحالية",
        ctaUpgrade: "ترقية",
        ctaChoose: "اختاري الباقة",
        perMonth: "/شهر",
      },
      upcoming: {
        title: "الموعد القادم",
        none: "لا توجد مواعيد قادمة",
        noneSub: "احجزي جلستك القادمة الآن.",
        bookSession: "احجزي جلسة",
        viewAppointment: "عرض الموعد",
      },
      cancel: {
        button: "إلغاء الاشتراك",
        dialogTitle: "هل تريدين إلغاء اشتراكك؟",
        dialogBody:
          "سيظل اشتراكك نشطاً حتى {date}، وبعد ذلك لن يتجدد تلقائياً.",
        bullet1: "سيتم تعطيل التجديد التلقائي فوراً.",
        bullet2: "يمكنكِ الاستمرار في استخدام جلساتك المتبقية حتى {date}.",
        bullet3:
          "سيظل طبيب الأطفال وأخصائي النفس المعينان لكِ نشطَين حتى انتهاء الاشتراك.",
        bullet4: "يمكنكِ الاشتراك مجدداً في أي وقت بعد انتهاء اشتراكك.",
        confirm: "إلغاء الاشتراك",
        keep: "الاحتفاظ بالاشتراك",
      },
      upgrade: {
        dialogTitle: "ترقية باقتك؟",
        dialogBody: "سيؤدي هذا إلى استبدال اشتراكك الحالي فوراً.",
        bullet1: "ستُفقد جلساتك المتبقية.",
        bullet2: "ستنتهي فترة اشتراكك الحالية فوراً.",
        bullet3: "سيتم إزالة طبيب الأطفال وأخصائي النفس الحاليين.",
        bullet4: "سيبدأ اشتراك جديد بعد إتمام الدفع.",
        bullet5: "ستختارين أطباء جدداً بعد إتمام الدفع.",
        confirm: "تأكيد الترقية",
        cancel: "الاحتفاظ بالباقة الحالية",
      },
      faq: {
        title: "الأسئلة الشائعة",
        subtitle: "كل ما تحتاجين معرفته عن الاشتراكات.",
        questions: [
          {
            q: "هل يمكنني إلغاء اشتراكي في أي وقت؟",
            a: "نعم. يظل اشتراكك نشطاً حتى نهاية فترة الفوترة الحالية.",
          },
          {
            q: "ماذا يحدث إذا لم أستخدمي جميع الجلسات؟",
            a: "تنتهي صلاحية الجلسات الشهرية غير المستخدمة في نهاية دورة الفوترة ولا تُنقل إلى الشهر التالي.",
          },
          {
            q: "هل يمكنني الترقية إلى باقة أعلى لاحقاً؟",
            a: "بالطبع. تُطبَّق الترقيات فوراً وتُعدَّل الفوترة وفقاً لذلك.",
          },
          {
            q: "كيف يتم حجز المواعيد؟",
            a: "تتم مطابقة المواعيد تلقائياً بناءً على توافر الطبيب والأم.",
          },
          {
            q: "هل سأتلقى تذكيرات؟",
            a: "نعم. ستتلقين إشعارات تذكيرية قبل كل استشارة مجدولة.",
          },
        ],
      },
    },
    medicalReports: {
      ...
      pageSubtitle: "جميع التقارير الطبية الصادرة عن أطبائك في مكان واحد.",
      ...
      empty: {
        ...
        subtitle: "ستظهر هنا التقارير الطبية الصادرة عن أطبائك بعد كل جلسة.",
      },
      emptyFiltered: {
        title: "لا توجد نتائج",
        subtitle: "حاولي تعديل معايير البحث أو التصفية.",
        clearFilters: "مسح التصفية",
      },
      error: {
        title: "تعذّر تحميل التقارير",
        subtitle: "حدث خطأ أثناء تحميل التقارير الطبية. يرجى المحاولة مرة أخرى.",
        retry: "إعادة المحاولة",
      },
    ...
    profile: {
      ...
      pageSubtitle:
        "إدارة معلوماتك الشخصية وسجلاتك الطبية وملفات أطفالك.",
      editButton: "تعديل الملف الشخصي",
      editingMode: "وضع التعديل",
      unsavedChanges: "تغييرات غير محفوظة",
      unsavedChangesHint: "احفظي تغييراتك قبل المغادرة.",
      ...
      medical: {
        title: "السجل الطبي",
        subtitle: "المعلومات الطبية والتاريخ الصحي.",
        complete: "الملف مكتمل",
        chronicDiseases: "الأمراض المزمنة",
        mentalWellness: "الحالة النفسية",
        currentAssessment: "التقييم الحالي",
        clinicalNotes: "ملاحظات سريرية",
        clinicalNotesHint:
          "أضيفي العمليات الجراحية والحساسيات والأدوية والملاحظات وغيرها من المعلومات الطبية المهمة.",
        clinicalNotesPlaceholder: "اكتبي التاريخ الطبي...",
      },
      children: {
        title: "ملفات الأطفال",
        subtitle: "إدارة ملفات أطفالك الطبية.",
        addChild: "إضافة طفل",
        noChildren: "ابدئي في بناء ملفات الأسرة",
        noChildrenSub:
          "أنشئي ملفاً لطفلك لتتبع التاريخ الطبي والحساسيات والتطعيمات ومعلومات الرعاية الصحية.",
        medicalSummary: "الملخص الطبي",
        noMedicalSummary: "لم يُضف أي تاريخ طبي أو حساسيات بعد.",
        viewProfile: "عرض الملف",
        addNewChild: "إضافة طفل جديد",
        addNewChildSub: "أنشئي ملفاً لطفل آخر",
        ageLabel: "العمر {n}",
        edit: "تعديل",
        delete: "حذف",
        deleteTitle: "حذف الطفل",
        deleteDesc:
          "لا يمكن التراجع عن هذا الإجراء. سيتم حذف سجل الطفل وصورة ملفه الشخصي نهائياً.",
        deleting: "جارٍ الحذف...",
      },
    },
  },
  en: {
    ...
    subscriptionWizard: {
      ...
      errors: {
        ...
        somethingWrong:
          "Something went wrong. Please try again or contact support.",
        alreadySubscribed:
          "You already have an active subscription. You cannot create a new one.",
      },
    },
    subscriptionDashboard: {
      status: {
      ...
      stats: {
        included: "Included Sessions",
        used: "Used Sessions",
        remaining: "Remaining",
        usage: "Usage",
      },
      plans: {
        sectionTitle: "Available Care Packages",
        sectionSubtitle: "Upgrade or change your subscription at any time.",
      ...
      upcoming: {
        ...
        noneSub: "Schedule your next consultation.",
        bookSession: "Book Session",
        viewAppointment: "View Appointment",
      },
      cancel: {
        button: "Cancel Subscription",
        dialogTitle: "Cancel your subscription?",
        dialogBody:
          "Your subscription will remain active until {date}, after which it will not renew automatically.",
        bullet1: "Auto-renewal will be disabled immediately.",
        bullet2:
          "You will retain access to your remaining sessions until {date}.",
        bullet3:
          "Your assigned Pediatrician and Psychologist will remain until expiry.",
        bullet4: "You can resubscribe at any time after your subscription ends.",
        confirm: "Cancel Subscription",
        keep: "Keep Subscription",
      },
      upgrade: {
        dialogTitle: "Upgrade your care package?",
        dialogBody: "This will immediately replace your current subscription.",
        bullet1: "Your remaining sessions will be forfeited.",
        bullet2: "Your remaining subscription period will end immediately.",
        bullet3:
          "Your current Pediatrician and Psychologist will be removed.",
        bullet4: "A new subscription will begin after successful payment.",
        bullet5: "You will select new doctors after completing payment.",
        confirm: "Confirm Upgrade",
        cancel: "Keep Current Plan",
      },
      faq: {
        title: "Frequently Asked Questions",
        subtitle: "Everything you need to know about subscriptions.",
        questions: [
          {
            q: "Can I cancel my subscription anytime?",
            a: "Yes. Your subscription remains active until the end of the current billing period.",
          },
          {
            q: "What happens if I don't use all sessions?",
            a: "Unused monthly sessions expire at the end of the billing cycle and do not roll over.",
          },
          {
            q: "Can I upgrade my package later?",
            a: "Absolutely. Upgrades are applied immediately, and billing is adjusted accordingly.",
          },
          {
            q: "How are appointments booked?",
            a: "Appointments are automatically matched with both the doctor's and mother's availability.",
          },
          {
            q: "Will I receive reminders?",
            a: "Yes. You'll receive reminder notifications before every scheduled consultation.",
          },
        ],
      },
    },
    medicalReports: {
      ...
      pageSubtitle: "All medical reports issued by your doctors, in one place.",
      ...
      empty: {
        ...
        subtitle: "Medical reports issued by your doctors will appear here after each session.",
      },
      emptyFiltered: {
      ...
      error: {
        ...
        subtitle: "Something went wrong while loading your medical reports. Please try again.",
        retry: "Try Again",
      },
    ...
    profile: {
      ...
      pageSubtitle:
        "Manage your personal information, medical records and children profiles.",
      editButton: "Edit Profile",
      editingMode: "Editing Mode",
      unsavedChanges: "Unsaved Changes",
      unsavedChangesHint: "Save your changes before leaving.",
      saveChanges: "Save Changes",
      saving: "Saving...",
      uploading: "Uploading...",
      loadingProfile: "Loading profile settings...",
      personal: {
      ...
      medical: {
        ...
        subtitle: "Clinical information and health history.",
        complete: "Profile Complete",
        chronicDiseases: "Chronic Diseases",
        mentalWellness: "Mental Wellness Status",
        currentAssessment: "Current Assessment",
        clinicalNotes: "Clinical Notes",
        clinicalNotesHint:
          "Include surgeries, allergies, medications, observations and other important medical information.",
        clinicalNotesPlaceholder: "Write medical history...",
      },
      children: {
        title: "Children Records",
        subtitle: "Manage your children's medical profiles.",
        addChild: "Add Child",
        noChildren: "Start Building Family Profiles",
        noChildrenSub:
          "Create a profile for your child to track medical history, allergies, vaccinations and healthcare information.",
        medicalSummary: "Medical Summary",
        noMedicalSummary:
          "No medical history or allergies have been added yet.",
        viewProfile: "View Profile",
        addNewChild: "Add New Child",
        addNewChildSub: "Create another child profile",
        ageLabel: "Age {n}",
        edit: "Edit",
        delete: "Delete",
        deleteTitle: "Delete Child",
        deleteDesc:
          "This action cannot be undone. The child record and their profile image will be permanently removed.",
        deleting: "Deleting...",
      },
    },
  },
