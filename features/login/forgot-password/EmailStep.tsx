...
//       <Link
//         href="/login"
//         className="mb-6 -mt-4 flex items-center gap-1.5 text-sm font-medium text-muted-foreground transition-colors hover:text-primary"
//       >
...
//       >
//         <Field>
//           <FieldLabel htmlFor="fp-email">{labels.step1.email_label}</FieldLabel>
          ...
          >
            {form.formState.isSubmitting ? (
              <span className="flex items-center justify-center gap-2">
                <Loader2 className="h-4 w-4 animate-spin" aria-hidden="true" />
                {/* يمكنك وضع نص التحميل المترجم هنا إذا وجد */}
              </span>
            ) : (
              labels.step1.submit
            )}
